        ...
        if (s.length()>0){
            ...
            for(int i=0;i<a.length;i++) {
                ...
                try {
                    ...
                    errorMessage = "";
                    System.out.println("Некорректно указано имя у работника №" + Worker.getId() + ",изменено на другое уникальное значение,можете исправить с помощью команды update.");
                ...
                try {
                    Worker.setEndDate(LocalDateTime.parse(b[7]));
                }
                catch (Exception e){
                    System.out.print(errorMessage);
                    errorMessage = "";
                ...
                try {
                    Worker.setPosition(Position.valueOf((b[8]).toUpperCase()));
                }
                catch (Exception e){
                    System.out.print(errorMessage);
                    errorMessage = "";
                ...
                try {
                    person.setEyeColor(Color.valueOf((b[10]).toUpperCase()));
                }
                catch (Exception e){
                    System.out.print(errorMessage);
                    errorMessage = "";
